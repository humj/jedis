...
public class JedisTest extends JedisCommandTestBase {
	...
	@Test
	public void retValueOfListPopOpr() {
		Jedis j = new Jedis("10.1.81.194", 6379);
		j.lpush("listtest1", "pushone");
		System.out.println(j.llen("listtest1"));
		System.out.println(j.lpop("listtest1"));
		System.out.println(j.lpop("listtest1"));
		System.out.println(j.lpop("listtest1"));
	}
}